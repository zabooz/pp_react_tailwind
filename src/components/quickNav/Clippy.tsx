    ...
    return (
        <Drawer open={isOpen} onClose={handleClose} className="pt-20">
            ...
            <Drawer.Items className=" flex justify-center">
                <Tabs aria-label="Tabs with underline" variant="underline" className="justify-center w-[90%] ">
                    <Tabs.Item
                        active
                        title={intl.formatMessage({ id: 'clippy.passwords', defaultMessage: 'Passwörter' })}
                    ...
                    <Tabs.Item title={intl.formatMessage({ id: 'clippy.usernames', defaultMessage: 'Benutzernamen' })}>
                        <ul>
                            {usernames.length > 0 &&
