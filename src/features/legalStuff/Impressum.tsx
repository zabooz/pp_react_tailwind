function Impressum() {
  return (
    <div>
      ...
      <p>
        Gemäß der Verordnung über Online-Streitbeilegung in
      ...
      <h2 id="haftung-fur-inhalte-dieser-website">
      ...
      <p>
        ...
        übernehmen, insbesondere für solche, die von Dritten bereitgestellt
      ...
      <h2 id="haftung-links-auf-dieser-website">
      ...
      <p>
        ...
        haben. Sollte uns Rechtswidrigkeiten bekannt werden, werden wir Links
        sofort entfernen.
      </p>
      <p>
      ...
      <p>
        Unsere Webseite verwendet Google Fonts, einen Dienst von Google Ireland
        Limited, Gordon House, Barrow Street, Dublin 4, Irland, zur
        einheitlichen Darstellung von Schriftarten. Google Fonts ist ein Dienst,
        der es uns ermöglicht, Schriften auf der Website einzubinden, ohne dass
        Sie diese Schriften lokal auf Ihrem Computer installieren müssen. Ihre
        IP-Adresse wird an Google weitergegeben, um die Schriftarten
        ordnungsgemäß darzustellen. Dies erfolgt durch Abruf der Google Fonts
        CSS-Datei von den Google-Servern und geschieht automatisch beim Laden
        unserer Webseite.
      </p>
      <p>
        Bei Fragen oder Anliegen zur Datenschutzbestimmungen oder zur
        Verarbeitung von Daten auf unserer Webseite können Sie uns gerne direkt
        kontaktieren.
      </p>
      <h2 id="fazit">Fazit</h2>
      <p>
        Zusammenfassend können wir sagen, dass der Datenschutz bei uns eine hohe
        Priorität hat. Wir nehmen Ihre Datenschutzrechte ernst und sind stets
        bemüht, die Bestimmungen der Datenschutz-Grundverordnung (DSGVO)
        einzuhalten. Wir hoffen, dass diese Datenschutzerklärung Ihnen eine
        umfassende und transparente Einsicht darüber gibt, wie Ihre Daten bei
        uns verarbeitet werden. Sollten Sie Fragen oder Bedenken haben, stehen
        wir Ihnen gerne für weitere Informationen zur Verfügung.
      </p>
      <p>
        <strong>Erläuterung:</strong> Personenbezogene Daten sind also all jene
        Daten, die Sie als Person identifizieren können. Das sind in der Regel
        Daten wie etwa:
      </p>
      <ul>
        <li>Name</li>
      ...
      <p>
        ...
        Werbeanalyseprogramme sammeln zum Beispiel Daten über Ihr Verhalten und
        Ihre Interessen auf einer Website. Daraus ergibt sich ein spezielles
      ...
      <blockquote>
        <p>
          <em>
            <strong>„Verantwortlicher“</strong> die natürliche oder juristische
      ...
      <p>
        ...
        der „Verantwortliche“. Wenn wir erhobene Daten zur Verarbeitung an
        andere Dienstleister weitergeben, sind diese „Auftragsverarbeiter“.
        Dafür muss ein „Auftragsverarbeitungsvertrag (AVV)“ unterzeichnet
        werden.
      </p>
      ...
      <p>
        <strong>Anmerkung:</strong> Wenn wir in unserer Datenschutzerklärung von
