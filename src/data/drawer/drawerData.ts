...
const paragraphLeet2 =
  "Leetspeak ersetzt Buchstaben durch ähnlich aussehende Zeichen. Zum Beispiel wird 'A' durch '4', 'E' durch '3' und 'I' durch '1' ersetzt. Wörter wie 'Leet' werden zu 'L33t', was der Kommunikation eine kreative Note verleiht.";

const paragraphLeet3 =
  "Leetspeak kann die Passwortsicherheit erhöhen, da es schwieriger wird, Passwörter zu erraten. Die Verwendung von Zahlen statt Buchstaben macht Passwörter weniger vorhersehbar, was angesichts zunehmender Cyberbedrohungen an Bedeutung gewonnen hat.";

const paragraphLeet4 =
  "Trotz der Vorteile ist Leetspeak nicht unfehlbar. Vorhersehbare Muster erleichtern Angreifern das Erraten von Buchstaben. Außerdem kann die Lesbarkeit eingeschränkt sein, was in manchen Kontexten problematisch ist. Dennoch bleibt es ein Ausdruck von Kreativität in Online-Communities.";
