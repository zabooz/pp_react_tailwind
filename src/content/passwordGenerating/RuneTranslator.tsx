...
function RuneTranslator({handleDrawerClick}: Props) {
  ...
  return (
        ...
        >
          ...
          <span className="font-bold cursor-pointer" onClick={() => handleDrawerClick(leetspeakTextShortened)}>Leetspeak</span> ersetzt die Buchstaben und Zeichen deine Passwortes mit anderen Zeichen, so dass du besser vor Angriffen geschützt bist. Probier aus, welche Variante - von einfach bis stark verändert - du bevorzugst.
          </p>
