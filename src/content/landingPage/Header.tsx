...
function Header() {
  ...
  return (
    <header
      className={`dark:bg-slate-800 dark:text-gray-400 min-h-screen flex flex-col items-center justify-evenly ${
      ...
      <div className=" flex flex-col-reverse lg:flex-row justify-center w-4/4 sm:w-3/4  items-center">
        <div className=" flex flex-col gap-10 items-center lg:items-start ">
          ...
          <div className=" flex flex-col gap-5 mt-5 text-lg  md:text-2xl lg:w-3/4 text-center md:text-left">
            ...
            <p className="mt-10 p-4  border-4 rounded-lg border-[#9ca3af]">
        ...
        <div className="mb-5 sm:mb-0  lg-w-1/3 ">
          <img
            ...
            className="max-w-[9rem] sm:max-w-[12rem] lg:max-w-[19rem] xl:max-w-[23rem] "
          ></img>
        </div>
      </div>
      <div>
        <img
          ...
          className="max-w-[5rem] cursor-pointer   mx-auto rotate-180"
