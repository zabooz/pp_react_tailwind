...
function Mojo() {
  ...
  return (
    ...
    >
      ...
      Wählen Sie einen Modus, um Ihr Passwort gegen Brute-Force-Angriffe zu testen. Im <span onClick={() => handleClickDrawer(bruteForceAttackSimple)} className="cursor-pointer font-bold">einfachen Modus</span> werden alle möglichen Zeichenkombinationen durchprobiert. Der <span onClick={() => handleClickDrawer(bruteForceAttackList)}className="cursor-pointer font-bold">Listen-Modus</span> prüft bekannte Passwörter
      </p>
      <div>
        <TextInput type="text" />
        <div>
    ...
    <OffCanvas handleClose={handleCloseDrawer} show={drawer} data={drawerContent}/>
    </>
  )
}
