...
<p>Daniel Osojnik</p>
<p>Seegasse 46<br />9020 Klagenfurt<br />Österreich</p>
<p><strong>E-Mail:</strong> <a href="mailto:hello@passwordplayground.com">hello@passwordplayground.com</a></p>

<h2 id="eu-streitschlichtung">EU-Streitschlichtung</h2>
<p>Gemäß der Verordnung über Online-Streitbeilegung in Verbraucherangelegenheiten (ODR-Verordnung) möchten wir Sie über die Online-Streitbeilegungsplattform (OS-Plattform) informieren.<br />
Verbraucher haben die Möglichkeit, Beschwerden an die Online-Streitbeilegungsplattform der Europäischen Kommission unter <a href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&amp;lng=DE" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&amp;lng=DE</a> zu richten. Die dafür notwendigen Kontaktdaten finden Sie oben in unserem Impressum.</p>
<p>Wir möchten Sie jedoch darauf hinweisen, dass wir nicht bereit oder verpflichtet sind, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>

<h2 id="haftung-fur-inhalte-dieser-website">Haftung für Inhalte dieser Website</h2>
<p>Wir entwickeln die Inhalte dieser Website ständig weiter und bemühen uns, korrekte und aktuelle Informationen bereitzustellen. Leider können wir keine Haftung für die Korrektheit aller Inhalte auf dieser Website übernehmen, insbesondere für solche, die von Dritten bereitgestellt wurden. Als Diensteanbieter sind wir nicht verpflichtet, die von Ihnen übermittelten oder gespeicherten Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen.</p>
...
<p>Sollten Ihnen problematische oder rechtswidrige Inhalte auffallen, bitten wir Sie, uns umgehend zu kontaktieren, damit wir die rechtswidrigen Inhalte entfernen können. Sie finden die Kontaktdaten im Impressum.</p>

<h2 id="haftung-links-auf-dieser-website">Haftung für Links auf dieser Website</h2>
<p>Unsere Website enthält Links zu anderen Websites, für deren Inhalt wir nicht verantwortlich sind. Haftung für verlinkte Websites besteht für uns nicht, da wir keine Kenntnis rechtswidriger Tätigkeiten hatten und haben. Sollte uns Rechtswidrigkeiten bekannt werden, werden wir Links sofort entfernen.</p>
...
<p><strong>Die Bilderrechte liegen bei:</strong><br />passwordplayground.com</p>
...
<p>Wir haben diese Datenschutzerklärung (Fassung 29.08.2024) verfasst, um Ihnen gemäß der Vorgaben der <a href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=122865215#d1e2269-1-1" target="_blank" rel="noopener noreferrer">Datenschutz-Grundverordnung (EU) 2016/679</a> und anwendbaren nationalen Gesetze zu erklären, welche personenbezogenen Daten (kurz Daten) wir als Verantwortliche – und die von uns beauftragten Auftragsverarbeiter (z. B. Provider) – verarbeiten, zukünftig verarbeiten werden und welche rechtmäßigen Möglichkeiten Sie haben. Die verwendeten Begriffe sind geschlechtsneutral zu verstehen.<br />
...
passwordplayground.com</p>
<p>E-Mail: <a href="mailto:hello@passwordplayground.com">hello@passwordplayground.com</a></p>
<p>Impressum: <a href="https://www.passwordplayground.com/impressum/">https://www.passwordplayground.com/impressum/</a></p>
...
<p>Unsere Webseite verwendet Google Fonts, einen Dienst von Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, zur einheitlichen Darstellung von Schriftarten. Google Fonts ist ein Dienst, der es uns ermöglicht, Schriften auf der Website einzubinden, ohne dass Sie diese Schriften lokal auf Ihrem Computer installieren müssen. Ihre IP-Adresse wird an Google weitergegeben, um die Schriftarten ordnungsgemäß darzustellen. Dies erfolgt durch Abruf der Google Fonts CSS-Datei von den Google-Servern und geschieht automatisch beim Laden unserer Webseite.</p>
<p>Bei Fragen oder Anliegen zur Datenschutzbestimmungen oder zur Verarbeitung von Daten auf unserer Webseite können Sie uns gerne direkt kontaktieren.</p>
<h2 id="fazit">Fazit</h2>
<p>Zusammenfassend können wir sagen, dass der Datenschutz bei uns eine hohe Priorität hat. Wir nehmen Ihre Datenschutzrechte ernst und sind stets bemüht, die Bestimmungen der Datenschutz-Grundverordnung (DSGVO) einzuhalten. Wir hoffen, dass diese Datenschutzerklärung Ihnen eine umfassende und transparente Einsicht darüber gibt, wie Ihre Daten bei uns verarbeitet werden. Sollten Sie Fragen oder Bedenken haben, stehen wir Ihnen gerne für weitere Informationen zur Verfügung.</p>
...
<p>Laut Europäischem Gerichtshof (EuGH) zählt auch Ihre <strong>IP-Adresse zu den personenbezogenen Daten</strong>. IT-Experten können anhand Ihrer IP-Adresse zumindest den ungefähren Standort Ihres Geräts und in weiterer Folge Sie als Anschlussinhaber feststellen. Daher benötigt auch das Speichern einer IP-Adresse eine Rechtsgrundlage im Sinne der DSGVO. Es gibt auch noch sogenannte <strong>„besondere Kategorien“</strong> der personenbezogenen Daten, die auch besonders schützenswert sind. Dazu zählen:</p>
<ul>
  ...
  <li>biometrische Daten (das sind Informationen zu psychischen, körperlichen oder verhaltenstypischen Merkmalen, die eine Person identifizieren können). Gesundheitsdaten</li>
...
<p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
<blockquote>
  <p><strong><em>„Verarbeitung“</em></strong> jeden mit oder ohne Hilfe automatisierter Verfahren ausgeführten Vorgang oder jede solche Vorgangsreihe im Zusammenhang mit personenbezogenen Daten wie das Erheben, das Erfassen, die Organisation, das Ordnen, die Speicherung, die Anpassung oder Veränderung, das Auslesen, das Abfragen, die Verwendung, die Offenlegung durch Übermittlung, Verbreitung oder eine andere Form der Bereitstellung, den Abgleich oder die Verknüpfung, die Einschränkung, das Löschen oder die Vernichtung;</p>
</blockquote>
...
<p>Alle Texte sind urheberrechtlich geschützt.</p>
<p>Quelle: Erstellt mit dem <a href="https://www.adsimple.at/datenschutz-generator/" title="Datenschutz Generator Österreich von AdSimple">Datenschutz Generator Österreich</a> von AdSimple</p>
